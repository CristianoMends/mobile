package com.edu.investidorapp.services
...
import com.edu.investidorapp.MainActivity
import com.google.firebase.messaging.FirebaseMessagingService
import com.google.firebase.messaging.RemoteMessage

open class FirebaseMessagingServic : FirebaseMessagingService() {
...
// Criação do canal de notificação (necessário no Android 8.0+)
        ...
        val notification = NotificationCompat.Builder(this, channelId)
            .setSmallIcon(com.edu.investidorapp.R.drawable.ic_launcher_foreground)
